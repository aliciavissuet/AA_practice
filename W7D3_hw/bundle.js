...
var GiphyIndex = function GiphyIndex(props) {
  ...
  return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", null, props.giphys.data && giphys.data.map(function (data, i) {
    return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_giphys_index_item__WEBPACK_IMPORTED_MODULE_1__["default"], {
      key: i,
      giphy: data.images.fixed_height.url
    });
  }));
};
...
var GiphyIndexItem = function GiphyIndexItem(props) {
...
var fetchSearchGiphys = function fetchSearchGiphys(searchterm) {
  return $.ajax({
    method: 'GET',
    url: "https://api.giphy.com/v1/gifs/search?q=".concat(searchterm, "&api_key=cswa1as0emsnDTuSN2tFJ31nRSLSP8bA&limit=20")
  });
};
